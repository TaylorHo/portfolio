...
const genFrontMatter = (answers) => {
  ...
  title: ${answers.title ? answers.title : 'Sem título'}
  date: '${date}'
...
inquirer
  ...
  .then((answers) => {
    ...
    if (!fs.existsSync('data/artigos')) fs.mkdirSync('data/artigos', { recursive: true })
    const filePath = `data/artigos/${fileName ? fileName : 'untitled'}.${
