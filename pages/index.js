        ...
        <div className="mb-12 flex flex-col items-center gap-x-12 xl:flex-row">
          <div className="pt-6">
            ...
            <h2 className="prose pt-5 text-lg text-gray-600 dark:text-gray-300">
              Sou engenheiro de cibersegurança, consultor na área, desenvolvedor, pesquisador,
              físico e autor. Amo aprender e experimentar coisas novas, especialmente com Código
              Livre. {/* Fundei a Hotay e */}Contribuo para projetos como Flutter, Quantum cirq,
              Debian e o Kernel Linux.
            </h2>
