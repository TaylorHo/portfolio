      ...
      <div className="flex flex-col items-start justify-start md:mt-24 md:flex-row md:items-center md:justify-center md:space-x-6">
        ...
        <div className="mx-auto max-w-2xl">
          <div className="md:border-l-2 md:px-6">
            ...
            <p className="mb-4">
              Por que mostrar uma página 404 genérica quando posso fazer isso parecer misterioso?
              Parece que você encontrou algo que existia e não existe mais ou você escreveu algo
              errado. Eu estou supondo que você escreveu alguma parte errada. Você pode verificar a
              URL da página?
            </p>
            <p>Mas não se preocupe, você pode encontrar muitas coisas legais na página inicial.</p>
          </div>
        </div>
      </div>
