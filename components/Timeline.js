    ...
    <div>
      <ol className="relative mt-6 ml-6 border-l border-zinc-400 dark:border-gray-800 ">
        ...
        <li className="mb-4 ml-8 rounded-md border border-gray-100 bg-white  px-4  py-4 shadow-sm shadow-gray-300 dark:border-zinc-900 dark:bg-zinc-900 dark:shadow-none">
          ...
          <p className="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
            Comecei a atuar como Consultor de Segurança pela Conviso Application Security.
          </p>
        </li>
        <li className="mb-4 ml-8 rounded-md border border-gray-100 bg-white px-4 py-4 shadow-sm shadow-gray-300 dark:border-zinc-900 dark:bg-zinc-900 dark:shadow-none">
        ...
        <li className="mb-4 ml-8 rounded-md border border-gray-100 bg-white  px-4  py-4 shadow-sm shadow-gray-300 dark:border-zinc-900 dark:bg-zinc-900 dark:shadow-none">
          ...
          <p className="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
            ...
            50k vulnerabilidades de segurança em 3 meses.
          </p>
        </li>
        <li className="mb-4 ml-8 rounded-md border border-gray-100 bg-white  px-4  py-4 shadow-sm shadow-gray-300 dark:border-zinc-900 dark:bg-zinc-900 dark:shadow-none">
        ...
        <li className="mb-4 ml-8 rounded-md border border-gray-100 bg-white  px-4  py-4 shadow-sm shadow-gray-300 dark:border-zinc-900 dark:bg-zinc-900 dark:shadow-none">
          ...
          <p className="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
            Professor de engenharia de software e segurança de aplicações em cursos focados em
            capacitar novos desenvolvedores em áreas não metropolitanas.
          </p>
        </li>
        <li className="mb-4 ml-8 rounded-md border border-gray-100 bg-white  px-4  py-4 shadow-sm shadow-gray-300 dark:border-zinc-900 dark:bg-zinc-900 dark:shadow-none">
          <span className="absolute -left-3 flex h-6 w-6 items-center justify-center rounded-full bg-yellow-300 ring-8 ring-white dark:bg-yellow-700 dark:ring-gray-900">
          ...
          <p className="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
            Iniciei em uma Fundação de Pesquisa e Desenvolvimento Científico e Tecnológico como
            pesquisador nas áreas de engenharia de software, segurança, criptografia e
            telecomunicações.
          </p>
        </li>
        <li className="mb-4 ml-8 rounded-md border border-gray-100 bg-white  px-4  py-4 shadow-sm shadow-gray-300 dark:border-zinc-900 dark:bg-zinc-900 dark:shadow-none">
              ...
              >
                <Disclosure.Panel>
                  ...
                  <li className="mb-4 ml-8 rounded-md border border-gray-100 bg-white  px-4  py-4 shadow-sm shadow-gray-300 dark:border-zinc-900 dark:bg-zinc-900 dark:shadow-none">
                    ...
                    <p className="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
                      Meu primeiro contato com a internet, gerando inúmeras perguntas sobre como
