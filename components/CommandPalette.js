import { Dialog, Combobox, Transition, TransitionChild } from '@headlessui/react'
          ...
          >
            ...
            >
              ...
              {filterednavigation.length > 0 && (
                <Combobox.Options static className="max-h-30 overflow-y-auto py-2 text-sm">
              ...
              {query && filterednavigation.length === 0 && (
                <p className="py-4 px-12 text-sm text-gray-500 ">nada encontrado</p>
              )}
            </Combobox>
          </TransitionChild>
        </Dialog>
