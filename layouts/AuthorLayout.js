        ...
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          ...
          <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
            <p>
              ...
              >
                Olá, eu sou o Taylor, apaixonado por tantas coisas que chega a ser difícil citar.
                Para ser breve, posso dizer que amo Código Livre e falo disso o tempo todo. Tenho um
                longo passado com Desenvolvimento de Software e cibersegurança, também tenho um
                livro publicado e estou me formando em Física - já tenho outras duas graduações em
                computação.
              </RoughNotation>
            </p>
            <br />
            <p className="sm:block md:hidden lg:hidden">
              Amo aprender algo novo e testar coisas diferentes, mas costumo focar em assuntos que{' '}
              <span className="font-semibold">envolvem computação, segurança ou fisica.</span> Este
              site é o meu lugar para falar{' '}
              <RoughNotation
                type="underline"
                show={true}
                color="#FBCFE8"
                ...
                multiline={true}
              >
                constantemente sobre programação de baixo nível, segurança, Código Livre, e talvez
                livre, e talvez algumas vezes sobre teorias físicas.
              </RoughNotation>
            </p>
            <p className="hidden md:block">
              ...
              >
                constantemente sobre programação de baixo nível, segurança, Código Livre, e talvez
                algumas vezes sobre teorias físicas.
              </RoughNotation>
            </p>
            <br />
            <p>
            ...
            <br />
            <p>Aqui você vai encontrar de tudo um pouco a meu respeito. Espero que goste.</p>
          </div>
        </div>
