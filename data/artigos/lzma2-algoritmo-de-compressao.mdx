...
date: '2023-01-12'
tags: ["Criptografia", "Algoritmos", "Hashing", "Linux", "Economia", "Infraestrutura"]
draft: false
summary: Para compressões maiores e mais eficazes podemos usar algoritmos de compressão mais "poderosos".
---

<img className="inline" src="/static/images/Blog/hashing-algoritm.png" alt="Hashing Algoritm" />
...
<SpecialLink
  link={"https://en.wikipedia.org/wiki/Dictionary_coder"}
  title={"Compressão de Dicionário"}
  description={"Mais informações sobre a Compressão de Dicionário"}
  site={"wikipedia.org"}
...
<SpecialLink
  link={"https://www.commandlinux.com/man-page/man1/lzma.1.html"}
  title={"Documentação do LZMA2"}
  description={"Link para a página do manual do comando lzma para Linux"}
  site={"commandlinux.com"}
  image={
