const experienceData = [
  {
    ...
    range: 'Abril 2023 - Presente',
    url: 'https://www.hotay.dev/',
    text1:
  ...
  },
  {
    ...
    range: 'Maio 2024 - Presente',
    url: 'https://www.convisoappsec.com/',
    text1:
  ...
  {
    title: 'AppSec and Red Team Security Engineer',
    company: 'Grupo SBF',
    location: 'São Paulo, Brasil',
    range: 'Fevereiro 2024 - Maio 2024',
    url: 'https://ri.gruposbf.com.br/',
    text1: 'Conduzi testes de penetração em APIs, aplicações web, móveis e desktop.',
    text2:
  ...
  },
  {
    ...
    company: 'Unialcance',
    location: 'Dois Irmãos, Rio Grande do Sul, Brasil',
    range: 'Fevereiro 2018 – Abril 2022',
    url: 'https://unialcance.com.br/',
    text1: 'Implementei sistemas SOAR, WAFs e atuei contra ameaças cibernéticas em tempo real.',
    text2: 'Planejei e Desenvolvi aplicações usando React, Angular, Flutter, NodeJS, PHP e Java.',
    text3:
